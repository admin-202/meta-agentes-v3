...
// real Hubla checkout/waitlist URLs from the workshop-exemplo landing page are used.
...
const INTL = "https://pay.hotmart.com/EXEMPLO0000?checkoutMode=10"; // secondary "international" CTA
...
describe("buildCheckoutHref — producer migrated to Hotmart, Hubla kept for affiliates", () => {
  ...
  // for the ?aff= channel. Mirrors workshop-exemplo after the 2026-06-13 Hubla→Hotmart migration.
  const PRODUCER = "https://pay.example.com/workshop-exemplo";
