...
// Surface A/B "review bridge" for the Nexus Live Review (SPEC-014 / ADR 0020).
//
...
//
// The matching orchestrator lives in web/ (lib/nexus/live-review.ts). Same protocol for both
...
// published page (example.com) is driven from the dashboard origin. Vercel preview deploys are
// matched by suffix below. Keep this list tight — it is the spoofing guard (STRIDE §6).
const EXTRA_ALLOWED_ORIGINS: readonly string[] = ["https://meta-ads-agents.vercel.app"];
