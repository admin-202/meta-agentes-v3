...
// Fixed glass header imported from claude-code.example.com: a code-style wordmark on the
...
export function SiteHeader() {
  ...
  // Wordmark tail: the subdomain reads like a code path ("Acme / workshop-exemplo").
