#!/usr/bin/env node
/*
 * send-email.cjs — transactional email via Resend for Nexus's autonomous mode (ADR 0019 /
...
// Generic template defaults. Override per-deploy via AUTONOMOUS_NOTIFY_EMAIL /
// AUTONOMOUS_FROM_EMAIL (the FROM domain must be verified in your Resend account).
const DEFAULT_TO = "operator@example.com";
const DEFAULT_FROM = "Assistant <noreply@example.com>";
