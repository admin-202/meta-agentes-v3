...
| Data | 2026-06-04 |
| Decidido por | Equipe |
| Spec | [SPEC-014](../specs/SPEC-014-nexus-live-review.md) |
| Relacionado | [SPEC-013](../specs/SPEC-013-nexus-autonomous-mode.md)/[ADR 0019](0019-nexus-autonomous-mode.md) (revisão headless), [ADR 0010](0010-nexus-screen-vision.md) (Nexus vê a tela), [ADR 0017](0017-shared-lp-render-package.md) |
...
- Uma aba **não lê/rola/printa** outra aba **cross-origin** (same-origin policy). A landing publicada
  (`example.com`) é cross-origin ao dashboard (`vercel.app`).
...
próximo`, até o rodapé. Reusa captura (ADR 0010), visão+voz (pipeline Nexus), preview (ADR 0017) e
