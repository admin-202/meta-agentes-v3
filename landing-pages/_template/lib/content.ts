...
import type { ContentSpec, Messages, ContentValue } from "@template/lp-render";
...
//
// The canonical content TYPES now live in @template/lp-render (shared by the live web
...
export type { SectionType, ContentSpec, CompareCell, Messages, Tone } from "@template/lp-render";
