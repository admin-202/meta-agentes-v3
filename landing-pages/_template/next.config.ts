...
const nextConfig: NextConfig = {
  ...
  // (this shell + @template/lp-render) is identical across every build. Type/lint checking
  ...
  // @template/lp-render is a symlinked file: dep; resolve its deep deps (three +
