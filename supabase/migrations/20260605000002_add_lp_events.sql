...
--
-- Espelho/resumo no Supabase dos eventos que o Worker `track.example.com` recebe e grava no D1
...
comment on table public.lp_events is
  'Espelho (resumo, SEM PII crua) dos eventos de tracking gravados no D1 pelo Worker track.example.com. Só para o dashboard de saúde ler via service_role. RLS deny-by-default. Ver ADR 0021 / docs/security/threats/landing-page-tracking.md.';
