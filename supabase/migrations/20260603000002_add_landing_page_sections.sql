...
-- VERDADE DO RASCUNHO. O operador (UI) e o Nexus (voz) editam `fields` (o copy do
...
-- `version` é concorrência otimista (UI e Nexus podem editar a mesma LP).
...
create table public.landing_page_sections (
  ...
  updated_by       text,                                -- 'operator' | 'nexus' | 'generator'
