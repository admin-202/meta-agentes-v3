...
-- no Cloudflare Pages sob <subdomain>.example.com. Segue as convenções da ADR 0002:
...
create table public.landing_pages (
  ...
  name                  text not null,                       -- label amigável (ex.: "CURSO")
  subdomain             text not null unique,                -- "curso-exemplo" → curso-exemplo.example.com (chave natural)
  fqdn                  text not null,                       -- "curso-exemplo.example.com"
  url                   text not null,                       -- "https://curso-exemplo.example.com"
  cloudflare_project_id text,                                -- "lp-curso-exemplo"
  repo_path             text not null,                       -- "landing-pages/curso-exemplo"
