-- Migration: add_nexus_review_bucket
-- ADR: docs/adr/0019-nexus-autonomous-mode.md (Fase 2 — revisão visual server-side)
-- Spec: docs/specs/SPEC-013-nexus-autonomous-mode.md §3.4 / §6 Fase 2
--
...
-- looks at it (vision) and narrates an opinion (nexus_narrations.image_path references the
...
values ('nexus-review', 'nexus-review', false)
