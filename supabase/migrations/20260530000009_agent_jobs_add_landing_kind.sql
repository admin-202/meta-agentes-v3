...
--
-- Permite que o Nexus enfileire criação de landing page (kind='landing'), executada
-- pela skill create-landing-page-cliente-exemplo no runner Fly. O índice único parcial
