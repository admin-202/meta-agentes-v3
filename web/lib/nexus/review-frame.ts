...
// One-shot vision for the Nexus Live Review (SPEC-014, Surface A). Given a single screen
...
const MODEL = process.env.NEXUS_REVIEW_MODEL ?? "claude-sonnet-4-6";
...
const SYSTEM_PROMPT =
  "Você é o Nexus, diretor de criação da Acme, revisando uma landing page AO VIVO com o " +
