...
// --- Landing page edits ---------------------------------------------------
// When Nexus applies a draft edit it writes straight to Supabase (no HTTP route),
...
export const LANDING_EDIT_CHANNEL = "nexus-landing-edits";
export const LANDING_EDIT_EVENT = "nexus-landing-edit";
...
// When Nexus's request_live_review tool fires, the chat reply carries this signal back to
...
export const LIVE_REVIEW_CHANNEL = "nexus-live-reviews";
export const LIVE_REVIEW_EVENT = "nexus-live-review";
