...
export const rateLimiters = {
  ...
  nexusCapture: () => limiter("nexus-capture", 15, "1 m"),
  ...
  nexusReview: () => limiter("nexus-review", 60, "1 m"),
  ...
  // Onboarding a client is rare and operator-only; a modest cap is defence-in-depth,
  // not a real bottleneck.
  clientCreation: () => limiter("client-creation", 10, "1 h"),
};
