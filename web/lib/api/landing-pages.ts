...
// Per-client publish skill (allowlist — never free-form). Mirrors the Nexus tools map.
...
const TRACK_ENDPOINT = process.env.TRACK_ENDPOINT ?? "https://track.example.com";
...
// The Worker (track.example.com) is the only reader. No endpoint here ever returns a secret value.
