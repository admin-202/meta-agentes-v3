      ...
      mapRunLifecycleEventsToLiveProcesses([
        {
          ...
          agent_name: "create-traffic-cliente-exemplo-campaign",
          event_type: "start",
          summary: "skill iniciada",
          payload: { skill: "create-traffic-cliente-exemplo-campaign" },
        },
      ]),
    ).toEqual([
      ...
      mapRunLifecycleEventsToLiveProcesses([
        {
          ...
          run_id: "run-1",
          ts: "2026-06-01T12:00:00.000Z",
          agent_name: "activate-campaign-cliente-exemplo",
          event_type: "start",
          summary: "skill iniciada",
          payload: { skill: "activate-campaign-cliente-exemplo" },
        },
        {
          id: "evt-2",
          run_id: "run-1",
          ...
          payload: { skill: "activate-campaign-cliente-exemplo", exit_code: 1 },
        },
      ]),
    ).toEqual([
      expect.objectContaining({
