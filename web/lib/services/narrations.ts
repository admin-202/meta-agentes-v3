...
/**
 * Server→browser narration channel for Nexus's autonomous mode (ADR 0019). The headless
 * watch-tick skill inserts rows into `nexus_narrations`; the operator's tab polls these and
