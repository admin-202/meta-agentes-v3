...
import { contentDocToFiles } from "@template/lp-render/serialize";
import type { ContentDoc } from "@template/lp-render/content-doc";

// Regression: the lp-copywriter (an LLM) generated workshop-exemplo with drifted section keys
