    ...
    <div className="space-y-7">
      ...
      {pages.length === 0 ? (
        <p className="text-sm text-white/50">
          Nenhuma landing page ainda. O Nexus cria uma nova pedindo cliente + produto.
        </p>
      ) : (
          ...
          {pages.map((lp) => {
            ...
            return (
              <li key={lp.id} className="tech-panel rounded-xl border border-white/8 p-4">
                ...
                <p className="mt-1 font-mono text-xs text-cyan-200/60">{lp.subdomain}.example.com</p>
                ...
                <div className="mt-3 flex items-center gap-3 text-xs">
                  ...
                  {editHref ? (
                    ...
                    <span
                      ...
                      title="LP sem produto associado — edite pelo Nexus ou associe um produto"
                    >
                      sem editor
                    </span>
                  )}
