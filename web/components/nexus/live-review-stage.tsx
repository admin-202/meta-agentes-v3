...
import { runLiveReview, type CapturedFrame, type LiveReviewProgress } from "@/lib/nexus/live-review";

// Surface A of the Nexus Live Review (SPEC-014): a fullscreen overlay that embeds the same-origin
...
// BroadcastChannel) emitted when Nexus's request_live_review tool fires.
//
    ...
    >
      ...
      <div className="border-t border-cyan-300/15 bg-[#06101a]/90 px-4 py-3 backdrop-blur">
        <p className="mx-auto max-w-3xl text-center text-sm leading-relaxed text-white/85">
          <span className="font-mono uppercase tracking-[0.16em] text-emerald-200/70">nexus </span>
          {caption}
        </p>
        {phase === "done" && (
