...
import type { ContentDoc, Settings, Theme } from "@template/lp-render/content-doc";
...
export function LandingPageEditor({
  ...
  // editing: reconcile leaves these alone so a remote (Nexus) edit can't clobber typing.
  ...
  // Push path: Nexus writes edits straight to Supabase, then the chat reply fans the
