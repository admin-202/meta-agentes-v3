...
// Tagging server MULTI-TENANT em track.example.com (ADR 0021). O Worker é amarrado à zona via
// Workers Routes (ver wrangler.toml). Same-site de todas as LPs (*.example.com) → cookies
