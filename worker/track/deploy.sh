...
#                            Zone DNS:Edit (zona example.com). (Pages:Edit já tem.)
...
echo "==> 5/5 Validação"
sleep 3
curl -fsS "https://track.example.com/healthy" && echo "  → /healthy OK" || echo "  (DNS pode levar 1-2 min p/ propagar; tente o /healthy de novo)"
echo "DONE."
